...
import { LayoutDashboard, Users, Building, Calendar, BarChart, LogOut, Loader2 } from "lucide-react";
      ...
      <Sidebar>
        <SidebarHeader>
          <div className="flex items-center gap-2">
            <Avatar>
              <AvatarImage src={user.photoURL || `https://placehold.co/40x40.png`} data-ai-hint="admin user" />
